...
const schema = Joi.object({
  ...
  P1_MIN_MOISTURE: Joi.number().min(0).max(100).default(30),
  ...
  P2_MIN_MOISTURE: Joi.number().min(0).max(100).default(25),
  ...
  P3_MIN_MOISTURE: Joi.number().min(0).max(100).default(20),
