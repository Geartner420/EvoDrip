...
//Zum Debug wieder einkommentieren
//console.log('[DEBUG] TELEGRAM_BOT_TOKEN aus .env:', process.env.TELEGRAM_BOT_TOKEN);
// Leere Strings in process.env in undefined umwandeln
...
if (error) {
    ...
    process.exit(1); // Stoppt das Skript
  }
  
  console.log('[DEBUG] config geladen:', config.UI_USERNAME); // Noch ein Test
